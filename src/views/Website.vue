<template>
  <div class="content">
    ...
    <div class="project">
      <h3>Ressources (2020)</h3>
      <p>
        This is a project I made for the CIIP. Ressources is a platform for the
        numerical resources of the french-speaking part of Switzerland. This
        platform was previously included on https://plandetudes.ch but is being
        remade from scratch. It will be integrated with the "Moyens
    ...
    <div class="project">
      <h3>MER (2020)</h3>
      <p>
        This is a project I made for the CIIP. Moyens d'enseignements romand is
        a platform for the teaching mediums of the french-speaking part of
        Switzerland. This platform was previously included on
    ...
    <div class="project">
      <h3>Connect by Bhaasha (2020)</h3>
      <p>
        Developing an app for the company Bhaasha by myself. This app manages
        meetings and contacts to make video conferences. The video conferencing
        is based on the WebRTC standard for peer to peer connections. It uses a
        TURN server as a relay for symmetric NATs. The backend uses MongoDB
        Node.js and Socket.io. The frontend is developed with VueJS. The project
      </p>
    </div>
    <div class="project">
      <h3>Prevasco, Novigenix (2020)</h3>
      <p>
        This is a project for a startup in the medical field. I've had to update
        one of their tool that manages the tracking and processing of blood
        samples in labs.
      </p>
      <div class="columns">
    ...
    <div class="project">
      <h3>Confluence visualisation (2020)</h3>
      <p>
        Visualizing data from Confluence using a treemap (and other views) using
        D3js.
      </p>
      <div class="columns">
        <video
    ...
    <div class="project">
      <h3>Oaka (2020)</h3>
      <p>
        This is the start of a big project. A series of tools for designers and
        developers.
      </p>
      <div class="columns">
    ...
    <div class="project">
      <h3>CV (2019)</h3>
      <p>
        This is my CV I made quickly using pure HTML/CSS before finding a job at
    ...
    <div class="project">
      <h3>Pixel (2019)</h3>
      <p>
        A pixel/image editor developed using pure Javascript along with HTML and
        CSS with 0 libraries.
    ...
    <div class="project">
      <h3>ChatRooms (2019)</h3>
      <p>
        A Node.js web app to make audio and text chat rooms. The application
        uses PeerJS to create a Peer to Peer network with handles NAT traversal.
        <a href="https://404">Not available yet!</a>.
      </p>
      <div class="columns">
    ...
    <div class="project">
      <h3>Yadlo (2019)</h3>
      <p>
        Simple one page website for a Kiosque owner.
    ...
    <div class="project">
      <h3>Battleship (2018)</h3>
      <p>
        A multiplayer battleship web based game. Source on
    ...
    <div class="project">
      ...
      <p>
        Project made for the "Information Visualisation" master course at
        HES-SO. Source on
    ...
    <div class="project">
      <h3>Swapp (2016)</h3>
      <p>
        A website to swapp items with others. You can search through items, add
        items and make propositions... There is also social functionalities,
    ...
    <div class="project">
      ...
      <p>
        An app for creating, administrating and participating in dynamic polls.
        <a href="https://github.com/servietsky777/TWEB-Labo2-Poll"
          >Can be found on Github here</a
    ...
    <div class="project">
      ...
      <p>
        A website which allows you to explore some of the data provided by the
        Github API.
        <a href="https://github.com/gsern1/TWEB-Labo1-GithubExplorer"
          >Can be found on Github here</a
        >
    ...
    <div class="project">
      ...
      <p>
        A gamification platform (REST API) made for a project. The image below
        is just an example of a gamified app...
        <a href="https://github.com/gsern1/AMT-Gamification-Platform"
          >Can be found on Github here</a
        >
      </p>
      <div class="columns">
    ...
    <div class="project">
      <h3>Task (2016)</h3>
      <p>
        Webapp storing and sorting tasks. Also viewing progress. It uses Node.JS
        and Socket.io. It also works on multiple devices connected at the same
        time.
      </p>
      <div class="columns">
    ...
    <div class="project">
      <h3>Board (2016)</h3>
      <p>
        Whiteboard webapp where you can write on a board multiple people at the
    ...
    <div class="project">
      <h3>OakStore (2016)</h3>
      <p>
        Webapp for storing last seen episode of TV shows, animes and movies. It
        uses Node.js and Socket.io. It also works on multiple devices connected
        at the same time.
      </p>
    ...
    <div class="project">
      <h3>Papyrus (2016)</h3>
      <p>Note taking webapp made with Node.js, Express and bookshelf.</p>
      <ul>
    ...
    <div class="project">
      ...
      <p>
        Free sound sound social network for downloading, listening and creating
        playlists.
      </p>
      <div class="columns">
    ...
    <div class="project">
      ...
      <p>
        The first site I created using HTML/CSS. It lists some free programs,
