...
It works on all platforms, including mobile and web.       </p>
    ...
    <div class="project">
      ...
      <p>
        ...
        allow neighbours to communicate. For example if they need an ingredient
        for cooking or want to propose dog walking... It includes real-time
    ...
    <div class="project">
      ...
      <p>
        Project realised for the "Mobile Operating Systems" master course at
        HES-SO. Source on
    ...
    <div class="project">
      ...
      <p>
        A chat made for a school project. Client is on Android and server uses
    ...
    <div class="project">
      <h3>SQLartan (2016)</h3>
      <p>
        A SQLite manager made for a school project. It looks a bit like
        phpmyadmin.
      </p>
      <div class="columns">
